...
CTLPLANE_IGN="/var/lib/libvirt/images/test-worker-0.ign"
BACKUP_FILE="/var/lib/libvirt/images/test-worker-0.ign.bak"
...
UUID="$(virsh domuuid test-worker-0)"
echo "Removing TPM data for UUID: $UUID"
rm /var/lib/libvirt/swtpm/$UUID -rf
echo "Removing old disk image"
rm /var/lib/libvirt/images/test-worker-0_0.img -f
echo "Creating new disk image based on: $VM_BASE_IMAGE"
qemu-img create -f qcow2 /var/lib/libvirt/images/test-worker-0_0.img -b $VM_BASE_IMAGE 60G -F qcow2
